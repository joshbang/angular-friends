...
.controller('friendController', function($scope) {
 ...
 $scope.randomStatus = ['old country Alabama!', 'red pick-up truck', 'cowboy boots', 'crushing it in ping pong', 'Its so much fun watching Akshar get wrecked in ping pong!', 'Josh sucks at foosball... Akshar skunked him!'];

 $scope.index = Math.floor(Math.random() * $scope.randomStatus.length);
 $scope.newStatus = $scope.randomStatus[$scope.index];

 $scope.sortPropArray = [{name: 'Name', value: 'name'},
